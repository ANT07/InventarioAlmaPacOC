            ...
            <div  class="col-xs-6 col-xs-offset-3 " id="cont" >
                ...
                <form action="vendedorescontrolador.do"  method="post" class="usuario form-horizontal" id="FormCrearUs">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6  inputGroupContainer">
                            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input type="text" class="form-control" placeholder="Nombre del vendedor" name="txtNombre" id="nombre" data-minLength="5" data-error="some error" required >
                            </div>
                        </div>
                    </div>
                    <!--Apellido-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6  inputGroupContainer">
                            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                                <input maxlength="8" id="telefonotxt" onkeypress="return valida(event)" name="txtTelefono" placeholder="Teléfono" class="form-control"  type="text" data-minLength="5" data-error="some error" required >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 selectContainer">
                            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                                <select name="sexoVendedor" class="form-control selectpicker" id="usuarioRol" data-minLength="5" data-error="some error" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6  inputGroupContainer">
                            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input maxlength="9" onkeypress="return valida(event)" name="txtDui" placeholder="Dui" class="form-control"  type="text" data-minLength="5" data-error="some error" required >
                            </div>
                        </div>
                    </div>
