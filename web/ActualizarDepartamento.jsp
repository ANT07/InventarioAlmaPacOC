                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6  inputGroupContainer">
                            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input type="text" class="form-control" value="${department.departmentname}" placeholder="Nombre Departamento" name="departmentname" id="departmentname" data-minLength="5" data-error="some error" required >
                            </div>
                        </div>
                    </div>
                    <center>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <center><b>¿Desea actualizar el departamento?</b></center>
                                </div>
                                <div class="modal-footer">
                                    <center>
                                        <a href="ListaDepartamentos.jsp"><button type="submit" class="btn btn-primary">Actualizar</button></a>
