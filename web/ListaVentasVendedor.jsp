    ...
    <center>
        ...
        <div class="container well" >
            ...
            <form action="ventascontrolador.do" method="POST">
                <input type="hidden" name="accion" value="ventasVendedor" >
                <div class="col-md-4 selectContainer">
                    <label class=" col-md-4 control-label" style="font-size: 16px" for="vendedorVenta" >Vendedor</label>
                    <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                            <%@include file="/WEB-INF/jspf/vendedorSelectAux.jspf" %>
            ...
            <h3 class="text-info col-md-4">Ventas de: ${vende.nombreVendedor} ${vende.apellidoVendedor}</h3>
            ...
            <br> <div class="form-group">
                ...
                <c:forEach var="venta" items="${vendedores}">
                    <tr>
                        <td><center><b>${venta.idVenta}</b></center></td>
                    <td><center>${utilClass.formatoFecha(venta.fechaVenta)}</center></td>
                    <td><center>$ ${venta.totalVenta}</center></td>
                    </tr>
                </c:forEach>
            </table>
